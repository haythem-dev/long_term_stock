...
namespace discount
{
WholesaleCustomerGroupArticleCalculatorCommand::WholesaleCustomerGroupArticleCalculatorCommand( 
...
const DiscountCalculatorResult & WholesaleCustomerGroupArticleCalculatorCommand::calculate() const
{
	CALC_BLOG_TRACE_METHOD( LoggerPool::getLoggerDiscountCalc(), "WholesaleCustomerGroupArticleCalculatorCommand::calculate()" );
