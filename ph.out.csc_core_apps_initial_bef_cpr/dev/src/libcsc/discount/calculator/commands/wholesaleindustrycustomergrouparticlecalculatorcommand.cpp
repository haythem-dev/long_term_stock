...
namespace discount
{
WholesaleIndustryCustomerGroupArticleCalculatorCommand::WholesaleIndustryCustomerGroupArticleCalculatorCommand( 
...
const DiscountCalculatorResult & WholesaleIndustryCustomerGroupArticleCalculatorCommand::calculate() const
{
	CALC_BLOG_TRACE_METHOD( LoggerPool::getLoggerDiscountCalc(), "WholesaleIndustryCustomerGroupArticleCalculatorCommand::calculate()" );
