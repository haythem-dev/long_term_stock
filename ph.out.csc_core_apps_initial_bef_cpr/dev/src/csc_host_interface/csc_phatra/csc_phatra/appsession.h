...
#ifndef GUARD_CSC_PHATRA_APPSESSION_H
#define GUARD_CSC_PHATRA_APPSESSION_H
...
namespace csc_phatra
{
	...
	{  
		public:
			AppSession(
				::libBatch::dbConnection::DBConnectionBasePtr csc,
				::libBatch::dbConnection::DBConnectionBasePtr tca);
			~AppSession();
...
#endif // end GUARD_CSC_PHATRA_APPSESSION_H
