...
/******************************************************************************/
 ...
 #define RUFPMASTER_ANZ ( sizeof(RUFPMASTER_BES) / sizeof(struct buf_desc) )
#endif
...
/******************************************************************************/
 ...
 #define RUFPTAG_ANZ ( sizeof(RUFPTAG_BES) / sizeof(struct buf_desc) )
#endif
...
/******************************************************************************/
 ...
 #define RUFPTAGINF_ANZ ( sizeof(RUFPTAGINF_BES) / sizeof(struct buf_desc) )
#endif
...
/******************************************************************************/
 ...
 #define RUFPTAGSUM_ANZ ( sizeof(RUFPTAGSUM_BES) / sizeof(struct buf_desc) )
#endif
...
/******************************************************************************/
 ...
 #define RUFPTAGTOUR_ANZ ( sizeof(RUFPTAGTOUR_BES) / sizeof(struct buf_desc) )
#endif
...
/******************************************************************************/
 ...
 #define RUFPTAGVOR_ANZ ( sizeof(RUFPTAGVOR_BES) / sizeof(struct buf_desc) )
#endif
