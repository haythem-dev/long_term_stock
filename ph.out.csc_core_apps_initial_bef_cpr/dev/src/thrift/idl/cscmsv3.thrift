...
const CscOrderTypeString CscOrderType_AKTIVORDER    = "AK";
...
const map<Msv3OrderTypeEnum, CscOrderTypeString> Msv3ToCSCOrderTypeMap =
{
	...
	Msv3OrderType.AKTIVORDER    :   CscOrderType_AKTIVORDER,
}
...
const map<CscOrderTypeString, Msv3OrderTypeEnum> CSCToMsv3OrderTypeMap =
{
	...
	CscOrderType_AKTIVORDER :   Msv3OrderType.AKTIVORDER,
}
...
struct Msv3TransmissionPreparationRequest
{
	...
	5:	optional string						InternalHash,				// internal XML hash
	6:	optional i16						InternalHashCheckTime,		// Check timespan to look back for identical hash
...
struct Msv3OrderPeriod
{
	...
	4:	optional cscbase.Time				OrderPeriodStartTime,		// HHMM
	5:  optional string						TourId
}
