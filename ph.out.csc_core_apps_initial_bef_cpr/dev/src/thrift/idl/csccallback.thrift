...
struct GetCallbackResponse
{
	...
	28: optional i16    StatusNo,            // d.CALLBACKSTATUSID
	29: optional string Reference,           // d.REFERENCE
...
struct CallbackStatusInquiryRequest
{
    1: optional i16    BranchNo,            // d.BRANCHNO 
}

struct CallbackStatusInquiryResponseItem
{
    1: optional i16    CallbackStatusNo,          // d.CALLBACKSTATUSNO
    2: optional string CallbackStatusName,        // d.CALLBACKSTATUSNAME
	3: optional i32    CallbackStatusFlag,        // d.CALLBACKSTATUSFLAG
}

typedef list<CallbackStatusInquiryResponseItem> CallbackStatusInquiryResponseItemList

struct CallbackStatusInquiryResponse
{
    1: optional CallbackStatusInquiryResponseItemList CallbackStatuses,

    10: optional cscbase.ReturnStruct RetValue,
}

struct CallbackStatusVisibilityInquiryRequest
{
    1: optional i16    BranchNo,            // d.BRANCHNO
	
}

struct CallbackStatusVisibilityInquiryResponse
{
    1: optional bool Visible,
...
struct NewCallbackCritPosRequest
{
	...
	7: optional i16    StatusNo,            // d.CALLBACKSTATUSID
}
...
struct NewCallbackRequest
{
	...
	41: optional i16    StatusNo,           // d.CALLBACKSTATUSID
	42: optional string Reference,          // d.REFERENCE
}
...
struct FindCallbacksResponseItem
{
     ...
     4: optional string ReasonName,              // d.REASONNAME
     5: optional string PharmacyName,       // NAMEAPO
     6: optional string City,               // ORT
     7: optional critlevelenum.CritLevelEnum CritLevel, // d.KRITIKLEVEL
	 8: optional string CallbackStatus,          // d.CALLBACKSTATUSNAME
	 9: optional string DivisionName,            // d.DIVISIONNAME
	10: optional string Reference,           // d.REFERENCE
}
