...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, FixedPrice_calculate_validFixedPrice_givenPrice )
{
...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, FixedPrice_log_validFixedPrice_validResult )
{
	DiscountBaseValuePtr fix( getFix() );
	addDiscountBaseValue( fix );
