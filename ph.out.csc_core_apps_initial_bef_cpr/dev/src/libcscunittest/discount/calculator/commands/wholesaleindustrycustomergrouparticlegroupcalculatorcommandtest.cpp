...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, WholesaleIndustryCustomerGroupArticleGroup_calculate_validFixedPrice_givenPrice )
{
...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, WholesaleIndustryCustomerGroupArticleGroup_log_validFixedPrice_validResult )
{
	CHECK_EQUAL( "TODO: to be implemented", "not implemented yet" );
