...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, WholesaleAllCustomerManufacturerGroup_calculate_validFixedPrice_givenPrice )
{
...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, WholesaleAllCustomerManufacturerGroup_log_validFixedPrice_validResult )
{
	CHECK_EQUAL( "TODO: to be implemented", "not implemented yet" );
