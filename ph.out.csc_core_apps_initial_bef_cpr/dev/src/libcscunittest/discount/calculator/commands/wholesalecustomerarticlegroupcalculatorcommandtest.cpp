...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, WholesaleCustomerArticleGroup_calculate_validFixedPrice_givenPrice )
{
...
FIXTURE_TEST_START( CommonCalculatorCommandFixture, WholesaleCustomerArticleGroup_log_validFixedPrice_validResult )
{
	CHECK_EQUAL( "TODO: to be implemented", "not implemented yet" );
