...
static const int cArtFlagMEntries = 5;
...
)   const
{
    ...
    unsigned long LongArray[cArtFlagMEntries];
    nBitMap::Export(LongArray, (size_t)cArtFlagMEntries, (size_t)cFlagBytesPerLong);
    l1 = (long) LongArray[0];
    l2 = (long) LongArray[1];
    l3 = (long) LongArray[2];
    l4 = (long) LongArray[3];
...
)
{
    ...
    nBitMap::Import(LongArray, (size_t)cArtFlagMEntries, (size_t)cFlagBytesPerLong);
}
