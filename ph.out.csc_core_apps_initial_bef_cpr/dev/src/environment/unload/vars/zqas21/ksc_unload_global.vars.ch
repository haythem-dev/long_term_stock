...
#============================================================================================#
export readonly BIN_PATH=$WSS/ch/ksc/unload/bin
export readonly LOG_PATH=$WSS/ch/ksc/unload/log
export readonly INI_PATH=$WSS/ch/ksc/unload/ini
export readonly PROC_PATH=$WSS/ch/ksc/unload/proc
export readonly DATA_PATH=$WSS/ch/ksc/unload/data
export readonly MODULE_PATH=$WSS/ch/ksc/unload
