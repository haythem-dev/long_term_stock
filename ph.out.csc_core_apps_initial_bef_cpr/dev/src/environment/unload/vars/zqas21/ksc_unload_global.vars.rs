...
#============================================================================================#
export readonly BIN_PATH=$WSS/rs/ksc/unload/bin
export readonly LOG_PATH=$WSS/rs/ksc/unload/log
export readonly INI_PATH=$WSS/rs/ksc/unload/ini
export readonly PROC_PATH=$WSS/rs/ksc/unload/proc
export readonly DATA_PATH=$WSS/rs/ksc/unload/data
export readonly MODULE_PATH=$WSS/rs/ksc/unload
