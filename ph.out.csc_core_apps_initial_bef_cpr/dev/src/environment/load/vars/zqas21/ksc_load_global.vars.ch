...
#============================================================================================#
export readonly BIN_PATH=/software/wss/ch/ksc/load/bin
export readonly LOG_PATH=/software/wss/ch/ksc/load/log
export readonly INI_PATH=/software/wss/ch/ksc/load/ini
export readonly PROC_PATH=/software/wss/ch/ksc/load/proc
export readonly DATA_PATH=/software/wss/ch/ksc/load/data
export readonly MODULE_PATH=/software/wss/ch/ksc/load
