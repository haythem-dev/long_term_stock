...
export INFORMIXDIR=/opt/lib/informix_csdk3.70
export LD_LIBRARY_PATH=/usr/local/lib:/opt/lib/informix_csdk3.70/lib:/opt/lib/informix_csdk3.70/SDK/lib:/opt/lib/informix_csdk3.70/lib/esql::

#============================================================================================#
# MODUL GLOBAL VARIABLES --> ATTENTION: INDIVIDUAL MODIFICATION REQUIRED (new variables) <--
#============================================================================================#
export readonly BIN_PATH=/software/wss/pat/ksc/load/bin
export readonly LOG_PATH=/software/wss/pat/ksc/load/log
export readonly INI_PATH=/software/wss/pat/ksc/load/ini
export readonly PROC_PATH=/software/wss/pat/ksc/load/proc
export readonly DATA_PATH=/software/wss/pat/ksc/load/data
export readonly MODULE_PATH=/software/wss/pat/ksc/load
