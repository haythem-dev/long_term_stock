...
#============================================================================================#
export readonly BIN_PATH=/software/wss/rs/ksc/load/bin
export readonly LOG_PATH=/software/wss/rs/ksc/load/log
export readonly INI_PATH=/software/wss/rs/ksc/load/ini
export readonly PROC_PATH=/software/wss/rs/ksc/load/proc
export readonly DATA_PATH=/software/wss/rs/ksc/load/data
export readonly MODULE_PATH=/software/wss/rs/ksc/load
