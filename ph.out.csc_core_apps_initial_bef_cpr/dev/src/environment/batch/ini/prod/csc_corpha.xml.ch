...
<KSCRefreshSettings xsi:noNamespaceSchemaLocation="KSCRefreshSettings.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<Country Country="CH">
		<Settings>
			...
			<SMTP Port="25" Host="10.100.121.30" SendMailFrom="csc_corpha_ch@phoenixgroup.eu">
			...
			<pxVerbund DeviceType="7" DeviceName="CORPHA" Computer="" LogMode="1" DataSource="och21@och21_shm" MessageFile="/software/wss/ch/ksc/batch/ini/message.txt" />
