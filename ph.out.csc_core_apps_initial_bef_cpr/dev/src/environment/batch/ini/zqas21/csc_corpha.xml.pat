...
<KSCRefreshSettings xsi:noNamespaceSchemaLocation="../../KSCRefreshSettings.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<Country Country="AT">
		<Settings>
			...
			<pxVerbund DeviceType="7" DeviceName="CORPHA" Computer="" LogMode="1" DataSource="oat21pre@zqas21_shm" MessageFile="/software/wss/pat/ksc/batch/ini/message.txt"/>
		...
		<Branches>
			<Branch BranchNo="83">
				<Settings>
					...
					<pxVerbund LogFile="/software/wss/pat/ksc/batch/log/cics02_csc_corpha.log" SystemLogFile="/software/wss/pat/ksc/batch/log/cics02_csc_corpha_wws.log"/>
				</Settings>
			</Branch>
		</Branches>
	</Country>
