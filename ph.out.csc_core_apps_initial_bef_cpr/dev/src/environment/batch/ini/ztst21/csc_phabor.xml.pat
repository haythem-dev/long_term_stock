...
<KSCRefreshSettings xsi:noNamespaceSchemaLocation="../../KSCRefreshSettings.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<Country Country="AT">
		<Settings>
			...
			<pxVerbund DeviceType="7" DeviceName="PHABOR" Computer="" LogMode="1" DataSource="oat21pre@ztst21_shm" MessageFile="/software/wss/pat/ksc/batch/ini/message.txt"/>
		...
		<Branches>
			<Branch BranchNo="83">
				<Settings>
					...
					<pxVerbund LogFile="/software/wss/pat/ksc/batch/log/83_csc_phabor.log" SystemLogFile="/software/wss/pat/ksc/batch/log/83_csc_phabor_wss.log"/>
				</Settings>
			</Branch>
		</Branches>
	</Country>
