...
<KSCRefreshSettings xsi:noNamespaceSchemaLocation="../../KSCRefreshSettings.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<Country Country="RS">
		<Settings>
			<General PollInterval="15000" LogLevel="Warnings" Test="false"/>
			<SMTP Port="25" Host="10.156.80.21" SendMailFrom="kscrefreshtest@phoenixgroup.eu">
				<Information eMail=""/>
				<Warnings eMail=""/>
				<Errors eMail="kscrefreshtest@phoenixgroup.eu"/>
			</SMTP>
			<TCAccess TCATransaction="TCAS" TCAHost="PhoenixGeneric_west" ConnectionRetries="10" ConnectionWaitBeforeRetry="10000" Username="PHABOR" Password="PHABOR"/>
		...
		<Branches>
			<Branch BranchNo="03">
				<Settings>
					...
					<pxVerbund LogFile="/software/wss/rs/ksc/batch/log/03_csc_phabor.log" SystemLogFile="/software/wss/rs/ksc/batch/log/03_csc_phabor_wss.log"/>
				</Settings>
			</Branch>
			<Branch BranchNo="84">
				<Settings>
					<TCAccess IPAddress="10.242.5.211" Port="3284"/>
					<pxVerbund LogFile="/software/wss/rs/ksc/batch/log/84_csc_phabor.log" SystemLogFile="/software/wss/rs/ksc/batch/log/84_csc_phabor_wss.log"/>
				</Settings>
			</Branch>
			<Branch BranchNo="85">
				<Settings>
					<TCAccess IPAddress="10.242.5.211" Port="3285"/>
					<pxVerbund LogFile="/software/wss/rs/ksc/batch/log/85_csc_phabor.log" SystemLogFile="/software/wss/rs/ksc/batch/log/85_csc_phabor_wss.log"/>
				</Settings>
			</Branch>
		</Branches>
	</Country>
