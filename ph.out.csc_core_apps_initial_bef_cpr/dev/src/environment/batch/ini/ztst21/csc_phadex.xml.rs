...
<KSCRefreshSettings xsi:noNamespaceSchemaLocation="KSCRefreshSettings.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<Country Country="RS">
		<Settings>
			...
			<pxVerbund DeviceType="7" DeviceName="PHADEX" Computer="" LogMode="1" DataSource="ors21@ztst21_shm" MessageFile="/software/wss/rs/ksc/batch/ini/message.txt"/>
		...
		<Branches>
			<Branch BranchNo="03">
				<Settings>
					...
					<pxVerbund LogFile="/software/wss/rs/ksc/batch/log/03_csc_phadex.log" SystemLogFile="/software/wss/rs/ksc/batch/log/03_csc_phadex_wss.log"/>
				</Settings>
			</Branch>
			<Branch BranchNo="84">
				<Settings>
					<TCAccess IPAddress="10.242.5.211" Port="3284"/>
					<pxVerbund LogFile="/software/wss/rs/ksc/batch/log/84_csc_phadex.log" SystemLogFile="/software/wss/rs/ksc/batch/log/84_csc_phadex_wss.log"/>
				</Settings>
			</Branch>
			<Branch BranchNo="85">
				<Settings>
					<TCAccess IPAddress="10.242.5.211" Port="3285"/>
					<pxVerbund LogFile="/software/wss/rs/ksc/batch/log/85_csc_phadex.log" SystemLogFile="/software/wss/rs/ksc/batch/log/85_csc_phadex_wss.log"/>
				</Settings>
			</Branch>
		</Branches>
	</Country>
