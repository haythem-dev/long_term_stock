...
<KSCRefreshSettings xsi:noNamespaceSchemaLocation="../../KSCRefreshSettings.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<Country Country="CH">
		<Settings>
			...
			<pxVerbund DeviceType="7" DeviceName="PHATRA" Computer="" LogMode="1" DataSource="och21@ztst21_shm" MessageFile="/software/wss/ch/ksc/batch/ini/message.txt"/>
		...
		<Branches>
			<Branch BranchNo="12">
				<Settings>
					...
					<pxVerbund LogFile="/software/wss/ch/ksc/batch/log/12_csc_phatra.log" SystemLogFile="/software/wss/ch/ksc/batch/log/12_csc_phatra_wss.log"/>
				</Settings>
			</Branch>
			<Branch BranchNo="13">
				<Settings>
