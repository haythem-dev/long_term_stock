...
#============================================================================================#
export readonly BIN_PATH=$WSS/pat/ksc/batch/bin
export readonly LOG_PATH=$WSS/pat/ksc/batch/log
export readonly INI_PATH=$WSS/pat/ksc/batch/ini
export readonly PROC_PATH=$WSS/pat/ksc/batch/proc
export readonly MODULE_PATH=$WSS/pat/ksc/batch
