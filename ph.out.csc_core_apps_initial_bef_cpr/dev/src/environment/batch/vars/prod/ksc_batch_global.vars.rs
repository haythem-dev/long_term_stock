...
#============================================================================================#
export readonly LOCKMAN=$WSS/rs/ksc/lockman/commonmem
export readonly BIN_PATH=$WSS/rs/ksc/batch/bin
export readonly LOG_PATH=$WSS/rs/ksc/batch/log
export readonly INI_PATH=$WSS/rs/ksc/batch/ini
export readonly PROC_PATH=$WSS/rs/ksc/batch/proc
export readonly DATA_PATH=$WSS/rs/ksc/batch/data
export readonly MODULE_PATH=$WSS/rs/ksc/batch
...
RT_CICS=$WSS/lib/tcaccess/8.0.11.4/sharedlib/release
