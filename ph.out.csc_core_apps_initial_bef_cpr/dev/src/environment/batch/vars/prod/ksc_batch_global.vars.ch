...
export readonly BIN_PATH=$WSS/ch/ksc/batch/bin
export readonly LOG_PATH=$WSS/ch/ksc/batch/log
export readonly INI_PATH=$WSS/ch/ksc/batch/ini
export readonly PROC_PATH=$WSS/ch/ksc/batch/proc
export readonly DATA_PATH=$WSS/ch/ksc/batch/data
export readonly MODULE_PATH=$WSS/ch/ksc/batch
