...
#============================================================================================#
export readonly LOCKMAN=$WSS/ch/ksc/lockman/commonmem
export readonly BIN_PATH=$WSS/ch/ksc/server/bin
export readonly LOG_PATH=$WSS/ch/ksc/server/log
export readonly INI_PATH=$WSS/ch/ksc/server/ini
export readonly PROC_PATH=$WSS/ch/ksc/server/proc
export readonly DATA_PATH=$WSS/ch/ksc/server/data
export readonly MODULE_PATH=$WSS/ch/ksc/server
