...
export readonly BIN_PATH=$WSS/rs/ksc/server/bin
export readonly LOG_PATH=$WSS/rs/ksc/server/log
export readonly INI_PATH=$WSS/rs/ksc/server/ini
export readonly PROC_PATH=$WSS/rs/ksc/server/proc
export readonly DATA_PATH=$WSS/rs/ksc/server/data
export readonly MODULE_PATH=$WSS/rs/ksc/server
