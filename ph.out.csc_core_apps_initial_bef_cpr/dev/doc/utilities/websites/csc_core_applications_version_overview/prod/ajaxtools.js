...
var vDEXML3 = null; var vDEXML3Finished = false; vDEXML3Result = null;
var vDEXML4 = null; var vDEXML4Finished = false; vDEXML4Result = null; // ode26
var vDEXML5 = null; var vDEXML5Finished = false; vDEXML5Result = null; // ode27
...
{    	
    ...
    if( country == "deXML3" ) { vDEXML3 = null; vDEXML3Finished = false; }	
    if( country == "deXML4" ) { vDEXML4 = null; vDEXML4Finished = false; }	
    if( country == "deXML5" ) { vDEXML5 = null; vDEXML5Finished = false; }	
}
...
{	
    ...
    if( country == "deXML3" ) { vDEXML3.open( "GET", url, true ); vDEXML3.onreadystatechange = updateSeite; vDEXML3.send( null ); }		
    if( country == "deXML4" ) { vDEXML4.open( "GET", url, true ); vDEXML4.onreadystatechange = updateSeite; vDEXML4.send( null ); }		
    if( country == "deXML5" ) { vDEXML5.open( "GET", url, true ); vDEXML5.onreadystatechange = updateSeite; vDEXML5.send( null ); }		
}
...
{		
    ...
    if( country == "deXML3" ) { try { vDEXML3 = new XMLHttpRequest(); } catch( tryMicrosoft ) { try { vDEXML3 = new ActiveXObject( "Msxml2.XMLHTTP" ); } catch( tryMicrosoft2 ) { try { vDEXML3 = new ActiveXObject( "Microsoft.XMLHTTP" ); } catch( error ) { vDEXML3 = null; } } } }		
    if( country == "deXML4" ) { try { vDEXML4 = new XMLHttpRequest(); } catch( tryMicrosoft ) { try { vDEXML4 = new ActiveXObject( "Msxml2.XMLHTTP" ); } catch( tryMicrosoft2 ) { try { vDEXML4 = new ActiveXObject( "Microsoft.XMLHTTP" ); } catch( error ) { vDEXML4 = null; } } } }		
    if( country == "deXML5" ) { try { vDEXML5 = new XMLHttpRequest(); } catch( tryMicrosoft ) { try { vDEXML5 = new ActiveXObject( "Msxml2.XMLHTTP" ); } catch( tryMicrosoft2 ) { try { vDEXML5 = new ActiveXObject( "Microsoft.XMLHTTP" ); } catch( error ) { vDEXML5 = null; } } } }		
}
...
{		
    ...
    if( country == "deXML3" ) { vDEXML3Result = document.getElementById( "DEXML3Result" ); }	
    if( country == "deXML4" ) { vDEXML4Result = document.getElementById( "DEXML4Result" ); }	
    if( country == "deXML5" ) { vDEXML5Result = document.getElementById( "DEXML5Result" ); }	
...
{	
    ...
    if( 4 == vDEXML3.readyState && vDEXML3Finished == false ){ vDEXML3Finished = true; replaceText( vDEXML3Result, vDEXML3.responseText ); }	
    if( 4 == vDEXML4.readyState && vDEXML4Finished == false ){ vDEXML4Finished = true; replaceText( vDEXML4Result, vDEXML4.responseText ); }	
    if( 4 == vDEXML5.readyState && vDEXML5Finished == false ){ vDEXML5Finished = true; replaceText( vDEXML5Result, vDEXML5.responseText ); }	
}
