...
<html>
	<head>
		<title>KSC Version Overview</title>
	...
	<body>		
		<h1>KSC Version Overview</h1>
		<p>
			|<a href="#at">Austria</a>
			|<a href="#pat">Austria Prewholesale</a>
			|<a href="#bg">Bulgaria</a>
			|<a href="#hr">Croatia</a>
			|<a href="#fr">France</a>
			|<a href="#pfr">France Prewholesale</a>
			|<a href="#de">Germany</a>
			|<a href="#rs">Serbia</a>
			|<a href="#ch">Switzerland</a>
			|<a href="#pch">Switzerland Prewholesale</a>
			|
		</p>			
		...
		<table width="100%">			
			...
			<tr><td> <span id="DEXMLResult">Requesting information for DEXML!</span></td></tr>									
			<tr><td> <span id="DEXML2Result">Requesting information for DEXML2!</span></td></tr>									
            <tr><td> <span id="DEXML3Result">Requesting information for DEXML3!</span></td></tr>									
            <tr><td> <span id="DEXML4Result">Requesting information for DEXML4!</span></td></tr>
            <tr><td> <span id="DEXML5Result">Requesting information for DEXML5!</span></td></tr>
