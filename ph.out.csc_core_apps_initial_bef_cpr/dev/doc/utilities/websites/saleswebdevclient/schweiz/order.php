...
$arrLinks      = getSalesWebLinks( 'order', 'CH' );
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/schweiz.gif" height="5%"/> &nbsp; Order Interface Switzerland</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                              <td><b>Passwort: </b></td>
                              <td><? showInputText( $_REQUEST, 'FRM_Passwort', true, 15 ); ?></td>
                          </tr>
                          <tr>
