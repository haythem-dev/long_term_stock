...
$arrLinks      = getSalesWebLinks( 'cucos', 'CH' );
$arrUser       = getSalesWebUser( 'CH' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/cucos.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/schweiz.gif" height="5%"/> &nbsp; CuCos Interface Switzerland</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request CuCos' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
