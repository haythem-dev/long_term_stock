...
$arrLinks      = getSalesWebLinks( 'deliverynote', 'CH' );
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/schweiz.gif" height="5%"/> &nbsp; Deliverynote Interface Switzerland</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request Deliverynote' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
