...
$arrLinks      = getSalesWebLinks( 'articlecatalogue', 'AT' );
$arrUser       = getSalesWebUser( 'AT' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/argeinfo.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/oesterreich.gif" height="5%"/> &nbsp; Articlecatalogue Interface Austria</h1>
