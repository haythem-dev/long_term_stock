...
$arrLinks      = getSalesWebLinks( 'pharmacies', 'RS' );
$arrUser       = getSalesWebUser( 'RS' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/pharmacies.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/serbia.jpg" height="5%"/> &nbsp; Pharmacies Interface Serbia</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request Pharmacies' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
