...
$arrLinks      = getSalesWebLinks( 'creditlimit', 'RS' );
$arrUser       = getSalesWebUser( 'RS' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/creditlimit.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/serbia.jpg" height="5%"/> &nbsp; CreditLimit Interface Serbia</h1>
