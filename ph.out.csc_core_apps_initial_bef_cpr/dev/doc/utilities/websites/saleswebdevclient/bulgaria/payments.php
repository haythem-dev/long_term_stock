...
$arrLinks      = getSalesWebLinks( 'payments', 'BG' );
$arrUser       = getSalesWebUser( 'BG' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/payments.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/bulgaria.jpg" height="5%"/> &nbsp; Payments Interface Bulgaria</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request Payments' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
