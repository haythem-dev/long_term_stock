...
$arrLinks      = getSalesWebLinks( 'articlecatalogue', 'DE' );
$arrUser       = getSalesWebUser( 'DE' );
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/deutschland.gif" height="5%"/> &nbsp; Articlecatalogue Interface Germany</h1>
