...
$arrLinks      = getSalesWebLinks( 'stocklevel', 'DE' );
$arrUser       = getSalesWebUser( 'DE' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/stocklevel.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/deutschland.gif" height="5%"/> &nbsp; Stocklevel Interface Germany</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request Stocklevel' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
