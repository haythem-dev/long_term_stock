...
$arrLinks      = getSalesWebLinks( 'deliverynotes', 'FR' );
$arrUser       = getSalesWebUser( 'FR' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/deliverynote.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/frankreich.gif" height="5%"/> &nbsp; DeliveryNotes Interface France</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request DeliveryNotes' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
	...
	if( isset( $_REQUEST['FRM_Submit'] ) )
	{
	    ...
	    $arrResult  = httpPostSimulation::multiplePostData( $strNumberRequests, $strLink."?idf=test", $strUsername, $strPassword, $strXMLRequest );
