...
$arrLinks      = getSalesWebLinks( 'order', 'FR' );
$arrUser       = getSalesWebUser( 'FR' );

if( !isset( $_REQUEST['FRM_XMLRequest'] ) )
{
    $_REQUEST['FRM_XMLRequest'] = file_get_contents( 'xmldata/order.xml' );
}
else
{
...
<body link="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF">
	<h1><img src="../images/frankreich.gif" height="5%"/> &nbsp; Order Interface France</h1>
                ...
                <fieldset>
                    <form method="POST" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <table style="font-size: 10pt">
                          ...
                          <tr>
                            <td colspan="2"><? showSubmit( 'FRM_Submit', 'Request Order' ); ?></td>
                          </tr>
                        </table>
                    </form>
                </fieldset>
