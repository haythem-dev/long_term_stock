...
struct OpenOrderRequest
{
	...
	42: optional i32						    DeliveryDate,			// d.DELIVERYDATE
...
struct OrderPositionResponse
{
	...
	30: optional double 				PricePharmacyPurchase,		// d->PHARMPURCHPRICE = orderitem->PreisEKApo();
	...
	33: optional double 				PricePurchase,				// d->PREISEKGROSSO = orderitem->PreisEKGrosso();
	...
	36: optional double 				PricePharmacySell,			// d->PHARMSELLPRICE = orderitem->PreisVKApo();
	37: optional double 				PriceBase,					// d->BASEPRICE = orderitem->BasePrice();
...
struct OrderValuesResponse
{
	...
	13: optional double 				TaxValFtaxFS,			//	= ps->Order()->OrderValues()->TaxValFtaxFS();
	14: optional double 				TaxValFtaxFSDisc,		//	= ps->Order()->OrderValues()->TaxValFtaxFSDisc();
	15: optional double 				TaxValFtaxHF,			//	= ps->Order()->OrderValues()->TaxValFtaxHF();
	16: optional double 				TaxValFtaxHFDisc,		//	= ps->Order()->OrderValues()->TaxValFtaxHFDisc();
	17: optional double 				TaxValFtaxRS,			//	= ps->Order()->OrderValues()->TaxValFtaxRS();
	18: optional double 				TaxValFtaxRSDisc,		//	= ps->Order()->OrderValues()->TaxValFtaxRSDisc();

	19: optional double 				TaxValLtaxFS,			//	= ps->Order()->OrderValues()->TaxValLtaxFS();
	20: optional double 				TaxValLtaxFSDisc,		//	= ps->Order()->OrderValues()->TaxValLtaxFSDisc();
	21: optional double 				TaxValLtaxHF,			//	= ps->Order()->OrderValues()->TaxValLtaxHF();
	22: optional double 				TaxValLtaxHFDisc,		//	= ps->Order()->OrderValues()->TaxValLtaxHFDisc();
	23: optional double 				TaxValLtaxRS,			//	= ps->Order()->OrderValues()->TaxValLtaxRS();
	24: optional double 				TaxValLtaxRSDisc,		//	= ps->Order()->OrderValues()->TaxValLtaxRSDisc();
}
