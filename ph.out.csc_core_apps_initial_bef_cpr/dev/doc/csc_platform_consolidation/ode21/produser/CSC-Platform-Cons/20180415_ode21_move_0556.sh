...
dos2unix /software/wss/de/bi/bin/unload_akdauftrag.bin /software/wss/de/bi/bin/unload_akdauftrag.bin
...
dos2unix /software/wss/de/bi/bin/unload_base_database.sh /software/wss/de/bi/bin/unload_base_database.sh
...
dos2unix /software/wss/de/ksc/load/vars/tpldhipath2.vars /software/wss/de/ksc/load/vars/tpldhipath2.vars
