...
echo '-------------------------------------'
LocalDir="/software/wss/de4/ksc/load/data/output"
...
echo '-------------------------------------'
LocalDir="/software/wss/de4/ksc/load/data/input"
...
echo '-------------------------------------'
SOURCE="/software/wss/de4/ksc/load/data/output/bestand-$BRANCHNO-*"
TARGET="/software/wss/de4/ksc/load/data/output/old"
...
SOURCE="/software/wss/de4/ksc/load/data/input/stocklevel-$BRANCHNO.*"
TARGET="/software/wss/de4/ksc/load/data/input/old"
for FILE in `ls $SOURCE`; do
	echo $FILE
	mv $FILE $TARGET
done
