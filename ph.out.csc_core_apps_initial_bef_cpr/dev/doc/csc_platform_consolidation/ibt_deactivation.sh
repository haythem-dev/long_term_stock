...
doSQL "
update ${FROMDB}:ibtbranches set active_flag=99 where (branchno=${BRANCHNO} or ibtbranchno=${BRANCHNO});
update ${TODB}:ibtbranches set active_flag=99 where (branchno=${BRANCHNO} or ibtbranchno=${BRANCHNO});
"
