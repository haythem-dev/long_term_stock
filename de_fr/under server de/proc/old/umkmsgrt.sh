#! /usr/bin/ksh
 ...
 #Creation-Time:     13:58                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary umkmsgrt for presentation only.              
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=umkmsgrt.ksc.bin
 ...
 {
 	 local _TEST_BINARY=${BIN_PATH}/${BINARY}.${n};
