#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary zaasunix for presentation only.              
 ###############################################################################################
 ...
 #LIBRARY PATH 
 readonly LIBRARY_PATH=${LIB_PATH}/marathon/ssuk-01.10.01.00/sharedlib/debug:${LIB_PATH}/tcaccess/8.0.11.4/sharedlib/release
 export LD_LIBRARY_PATH=${LIBRARY_PATH}:${LD_LIBRARY_PATH}
 readonly BINARY=zaasunix.bin
