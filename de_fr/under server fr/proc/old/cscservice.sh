#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary cscserver for presentation only.             
 ###############################################################################################
 ...
 #LIBRARY PATH 
 readonly LIBRARY_PATH=${LIB_PATH}/marathon/ssuk-01.12.00.00/sharedlib/debug:${LIB_PATH}/tcaccess/8.0.11.4/sharedlib/release:${LIB_PATH}/thrift/0.9.3_vc10_3/sharedlib/release
 # FORK_LIMIT_VERSION:
 #readonly LIBRARY_PATH=${LIB_PATH}/marathon/ssuk-01.12.00.00/sharedlib/debug:${LIB_PATH}/tcaccess/8.0.11.4/sharedlib/release:${LIB_PATH}/thrift/0.9.3_vc10_3_pre2/sharedlib/release
 export LD_LIBRARY_PATH=${LIBRARY_PATH}:${LD_LIBRARY_PATH}
 readonly BINARY=cscservice.bin
 ...
 readonly DONTFORK_OPTION="-dontfork";
 ...
 function print_local_var
 {
	 ...
	 printf "%-30s%-90s\n" "\$DONTFORK_OPTION:" ">$DONTFORK_OPTION<"
 ...
 {
	 local _parameters="";
 	 if (( ${dontfork_flag} == 1 )); then
 		 _parameters="${_parameters} $DONTFORK_OPTION ";
 	 fi
...
export CSC_LOGDATE=`date +"%Y%m%d"`;
 ...
 . $(dirname $0)/../vars/cscservice.vars;
