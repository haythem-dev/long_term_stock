#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary zaapunix for presentation only.              
 ###############################################################################################
